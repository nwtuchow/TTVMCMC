...
nsamp=8
sampfuncs=[fhmc1,fhmc2,fhmc3,fhmc5,fhmc7,fmala,fsmmala,fmamala1]
useMAMALA=[false,false,false,false,false,false,false,true]
...
for q in 1:nsamp
    ...
    tune_arr[q]=tuneSampler(sampfuncs[q],plogtarget,pgradlogtarget,ptensorlogtarget,
        numtune=10,nstep=20000,narrow=2,start=start,stop=stop,MAMALAtuner=useMAMALA[q])
