#fit simple sinusoid to TTVFaster data
using Optim
using ForwardDiff
...
pinit=[bData[1,1],P_b,0.003,0.003, -0.0003,0.0001,2*pi/P_TTV,cData[1,1],P_c, 0.002,0.002,0.000,0.000,2*pi/P_TTV]
...
writedlm("sinHarmonicFit_bData.txt",sinHarFitb,",")
writedlm("sinHarmonicFit_cData.txt",sinHarFitc,",")
writedlm("pf_bData.txt",pf,",") #actually for b and c data
