...
numsteps=10
driftsteps= logspace(-4.0,0.0,numsteps)
...
#=
writedlm("../outputs/aclength_MAMALA_transformedTTVFaster.txt", aclengths, ",")
writedlm("../outputs/ess_MAMALA_transformedTTVFaster.txt", ess_array, ",")
writedlm("../outputs/accept_MAMALA_transformedTTVFaster.txt", accrate, ",")
writedlm("../outputs/step_MAMALA_transformedTTVFaster.txt", driftsteps, ",")
=#
