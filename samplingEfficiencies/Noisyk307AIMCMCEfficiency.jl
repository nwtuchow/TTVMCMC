...
pop_init=readdlm("../outputs/NoisyensembleLast.txt",',')
numsteps=10000
tic()
...
diagnostic_array=readdlm("../outputs/Noisydiagnostics.txt",',')
...
writedlm("../outputs/Noisydiagnostics.txt", diagnostic_array, ",")
