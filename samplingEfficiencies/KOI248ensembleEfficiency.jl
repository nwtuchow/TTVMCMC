...
pop_init=readdlm("../outputs/KOI248ensembleLast.txt",',')
numsteps=10000
tic()
...
diagnostic_array=readdlm("../outputs/KOI248diagnostics.txt",',')
...
writedlm("../outputs/KOI248diagnostics.txt", diagnostic_array, ",")
