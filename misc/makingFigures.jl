...
########################
#SSM data plot
SSMptrue=readdlm("../outputs/pf_bData2.txt", ',')
SSMptrue=vec(SSMptrue)
SSMbData=readdlm("../outputs/sinHarmonicFit_bData2.txt", ',')
SSMcData=readdlm("../outputs/sinHarmonicFit_cData2.txt", ',')
...
k307ptrue=readdlm("../outputs/TTVFasterptrue.txt",',')
k307ptrue=vec(k307ptrue)
k307bData=readdlm("../outputs/TTVFasterbData.txt",',')
k307cData=readdlm("../outputs/TTVFastercData.txt",',')
...
Noisyptrue=readdlm("../outputs/Noisyptrue.txt",',')
Noisyptrue=vec(Noisyptrue)
NoisybData=readdlm("../outputs/NoisybData.txt",',')
NoisycData=readdlm("../outputs/NoisycData.txt",',')
...
k49ptrue=readdlm("../outputs/KOI248ptrue.txt",',')
k49ptrue=vec(k49ptrue)
k49bData=readdlm("../outputs/KOI248bData.txt",',')
k49cData=readdlm("../outputs/KOI248cData.txt",',')
...
##################################################
#kepler 57 data plot
k57ptrue=readdlm("../outputs/KOI1270ptrue.txt",',')
k57ptrue=vec(k57ptrue)
k57bData=readdlm("../outputs/KOI1270bData.txt",',')
k57cData=readdlm("../outputs/KOI1270cData.txt",',')
...
writedlm("../outputs/MALA_accept.txt",tune_arr["accrate"],",")
writedlm("../outputs/MALA_drift.txt",tune_arr["driftsteps"],",")

accrates=tune_arr["accrate"]
stepsizes=tune_arr["driftsteps"]
=#
accrates=readdlm("../outputs/MALA_accept.txt",',')
stepsizes=readdlm("../outputs/MALA_drift.txt",',')
