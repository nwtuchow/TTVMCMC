#simulate noisy kepler 307 inspired data set
...
writedlm("../outputs/NoisybData.txt",bdata2,",")
writedlm("../outputs/NoisycData.txt",cdata2,",")
writedlm("../outputs/Noisyptrue.txt",pinit,",")
