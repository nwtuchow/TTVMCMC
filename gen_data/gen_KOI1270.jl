...
candidatedata=readdlm("../misc/CandidateTTVs.txt",skipstart=20)
...
writedlm("../outputs/KOI-1270.01.txt",k57bData,",")
writedlm("../outputs/KOI-1270.02.txt",k57cData,",")
...
writedlm("../outputs/KOI1270bData.txt",bdata,",")
writedlm("../outputs/KOI1270cData.txt",cdata,",")
writedlm("../outputs/KOI1270ptrue.txt",pinit,",")
